...
<html lang="en">
  ...
  <body>
    ...
    for (int i = 0; i < actividades.size(); i++){
    	...
    	out.println("<tr>" + 
    	"<td styñes='background-color:white'>" + actividad.getNombre() + "</td>" + 
    	"<td styñes='background-color:white'>" + actividad.getFecha_inicio() + "</td>" + 
    	"<td styñes='background-color:white'>" + actividad.getDias() + "</td>" + 
    			"</tr>");
    }
    %>
    </table>
