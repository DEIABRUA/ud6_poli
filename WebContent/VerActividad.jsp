...
<html lang="en">
  ...
  <div class="row">
   <div class="col">
    <h1 class="text-center">Aktibitatearen izena</h1>
   </div>
  </div>
  <br>
  <div class="row">
  ...
  <br>
  <div class="row">
   <div class="col text-center font-weight-bold">Asteko egunak</div>
   <div class="col text-center font-weight-bold">Lunes, Miercoles</div>
  </div>
  <br>
  <div class="row">
   <div class="col text-center font-weight-bold">Orduak</div>
  ...
  <br>
  <div class="row">
   <div class="col text-center font-weight-bold">Prezioa</div>
