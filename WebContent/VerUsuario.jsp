...
<body>
  ...
  <div class="row">
   <div class="col">
    <h1 class="text-center">Usuarioaren izena</h1>
   </div>
  </div>
  <br>
  <div class="row">
   <div class="col text-center font-weight-bold">Dni</div>
   <div class="col text-center font-weight-bold">11111111a</div>
  </div>
  <br>
  <div class="row">
   <div class="col text-center font-weight-bold">Kodigoa</div>
   <div class="col text-center font-weight-bold">1000</div>
  </div>
  <br>
  <br>
  <div class="row">
